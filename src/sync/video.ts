...
export const VideoInfoMap: Record<string, PlatformInfo> = {
  ...
  VIDEO_NETEASE: {
    ...
    injectUrl: "https://mp.163.com/subscribe_v4/index.html#/video-publish",
  ...
  VIDEO_YIDIAN: {
    ...
    injectUrl: "https://mp.yidianzixun.com/#/Writing/videoEditor",
  ...
  VIDEO_PINDUODUO: {
    ...
    injectUrl: "https://live.pinduoduo.com/n-creator/video/home",
  ...
  VIDEO_VIVOVIDEO: {
    ...
    homeUrl: "https://www.kaixinkan.com.cn/",
